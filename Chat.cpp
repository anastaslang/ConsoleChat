...
void Chat::userMenu() //меню пользователя
{
    ...
    //выбор операции
        ...
        case '1':
            ...
            break;
        case '2':
            writeMessage();//написать и отправить сообщение
            break;
        case '3':
            showAllUsers();//показать всех зарегистрированных пользователей
            break;
        case '0':
...
void Chat::writeMessage()//написание и  добавление сообщений в контейнер
{
    std::string to, text;
